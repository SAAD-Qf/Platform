      ...
      <section className="py-20 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/products/all">
              <Button className="bg-white text-black hover:bg-neutral-light transition-colors px-8 py-4">
                Shop Collection
              </Button>
            </Link>
            <Link href="/products/featured">
              <Button variant="outline" className="border-white text-white hover:bg-white hover:text-black transition-colors px-8 py-4">
                View Featured Items
              </Button>
            </Link>
          </div>
